...
<div class="container">
<div class="text-center"><span class="section-tag">Study Destinations</span>
<h2 class="section-title">Choose Your Dream Destination</h2>
<p class="section-subtitle">We partner with top universities across the globe. Pick a destination and start your journey.</p></div>
<div class="dest-grid">
<?php
$destinations = [
...
<div class="dest-card">
  <div class="dest-card-img"><img src="<?=$d['img']?>" alt="<?=$d['name']?>"><span class="flag"><?=$d['flag']?></span></div>
  <div class="dest-card-body"><h3><?=$d['name']?></h3><p><?=$d['desc']?></p><a href="#" class="dest-link">Explore <i class="fas fa-arrow-right"></i></a></div>
</div>
<?php endforeach; ?>
</div></div>
</section>
...
<div class="container">
<div class="text-center"><span class="section-tag">Our Services</span>
<h2 class="section-title">End-to-End Support for Your Journey</h2>
<p class="section-subtitle">From your first consultation to landing at your dream university, we handle everything.</p></div>
...
<div class="container">
<div class="text-center"><span class="section-tag">How It Works</span>
<h2 class="section-title">Your Journey in 4 Simple Steps</h2>
<p class="section-subtitle">We make the entire process smooth and stress-free from start to finish.</p></div>
...
<div class="container"><div class="text-center"><span class="section-tag">Our Partners</span><h2 class="section-title">500+ Partner Universities Worldwide</h2></div></div>
<div class="uni-track"><div class="uni-slider">
...
<div class="container">
<div class="text-center"><span class="section-tag">Student Stories</span>
<h2 class="section-title">What Our Students Say</h2>
<p class="section-subtitle">Hear from students who achieved their dreams through our guidance.</p></div>
<div class="test-slider"><div class="test-track">
<div class="test-card">
<?php
$tests = [
...
foreach($tests as $i=>$t): if($i>0 && $i%3==0) echo '</div><div class="test-card">'; ?>
<div class="test-item">
  <div class="test-stars">★★★★★</div>
  <p>"<?=$t['text']?>"</p>
  <div class="test-author"><div class="test-avatar"><?=$t['init']?></div><div class="test-info"><h4><?=$t['name']?></h4><span><?=$t['uni']?></span></div></div>
</div>
<?php endforeach; ?>
</div></div></div>
<div class="test-nav"><button class="test-prev"><i class="fas fa-chevron-left"></i></button><button class="test-next"><i class="fas fa-chevron-right"></i></button></div>
</div>
</section>
...
<div class="container">
<div class="text-center"><span class="section-tag">Financial Aid</span>
<h2 class="section-title">Scholarship & Funding Opportunities</h2>
<p class="section-subtitle">Discover ways to fund your studies with various scholarships available for international students.</p></div>
...
<div class="container">
<div class="text-center"><span class="section-tag">Upcoming Events</span>
<h2 class="section-title">Meet Us at Our Next Event</h2>
<p class="section-subtitle">Join our education expos, spot assessments, and counselling sessions.</p></div>
<div class="events-grid">
<div class="event-card"><div class="event-date-bar"><span class="day">15</span><span class="month-year">May<br>2026</span></div><div class="event-body"><h3>Multi-Destination Education Expo – Dhaka</h3><p>Meet representatives from top UK, Canada & Australia universities. Free entry!</p><a href="#contact" class="btn btn-primary">Register Now</a></div></div>
<div class="event-card"><div class="event-date-bar"><span class="day">22</span><span class="month-year">May<br>2026</span></div><div class="event-body"><h3>UK University Spot Assessment Day</h3><p>Get on-the-spot offers from leading UK universities. Bring your documents!</p><a href="#contact" class="btn btn-primary">Register Now</a></div></div>
<div class="event-card"><div class="event-date-bar"><span class="day">01</span><span class="month-year">Jun<br>2026</span></div><div class="event-body"><h3>Scholarship Guidance Seminar</h3><p>Learn how to secure scholarships for UK, Canada, Australia & Europe.</p><a href="#contact" class="btn btn-primary">Register Now</a></div></div>
</div></div>
</section>
...
<div class="container">
<div class="text-center"><span class="section-tag">Latest Insights</span>
<h2 class="section-title">News & Blog</h2>
<p class="section-subtitle">Expert advice, trends, and guides to help you make informed decisions.</p></div>
<div class="blog-grid">
<div class="blog-card"><div class="blog-img"><img src="https://images.unsplash.com/photo-1434030216411-0b793f4b4173?w=600&q=80" alt="Blog"></div><div class="blog-body"><span class="blog-tag">Study in UK</span><h3>Cost of Living in UK for Bangladeshi Students: Complete Guide 2026</h3><p>Everything you need to know about accommodation, food, transport, and other living costs in the UK...</p><div class="blog-meta"><span><i class="far fa-calendar"></i> May 2, 2026</span><span><i class="far fa-clock"></i> 5 min read</span></div></div></div>
<div class="blog-card"><div class="blog-img"><img src="https://images.unsplash.com/photo-1523240795612-9a054b0db644?w=600&q=80" alt="Blog"></div><div class="blog-body"><span class="blog-tag">Canada</span><h3>Top 10 Universities in Canada 2026 – QS Rankings & Student Guide</h3><p>Discover the best Canadian universities, rankings, programs, tuition, and admission tips...</p><div class="blog-meta"><span><i class="far fa-calendar"></i> Apr 29, 2026</span><span><i class="far fa-clock"></i> 7 min read</span></div></div></div>
<div class="blog-card"><div class="blog-img"><img src="https://images.unsplash.com/photo-1552664730-d307ca884978?w=600&q=80" alt="Blog"></div><div class="blog-body"><span class="blog-tag">Visa Guide</span><h3>How to Justify Your Study Gap and Get a Visa in 2026</h3><p>Worried about your study gap? Learn how to address it in your visa application with confidence...</p><div class="blog-meta"><span><i class="far fa-calendar"></i> Apr 15, 2026</span><span><i class="far fa-clock"></i> 4 min read</span></div></div></div>
</div></div>
</section>
...
<div class="container">
<div class="text-center"><span class="section-tag">FAQ</span>
<h2 class="section-title">Frequently Asked Questions</h2>
<p class="section-subtitle">Find answers to common questions about studying abroad.</p></div>
<div class="faq-list">
<?php
$faqs = [
...
foreach($faqs as $f): ?>
<div class="faq-item"><div class="faq-q"><span><?=$f['q']?></span><span class="icon"><i class="fas fa-chevron-down"></i></span></div><div class="faq-a"><div class="faq-a-inner"><?=$f['a']?></div></div></div>
<?php endforeach; ?>
</div></div>
</section>
...
<a href="#contact" class="btn btn-primary" style="font-size:1.05rem;padding:16px 40px"><i class="fas fa-calendar-check"></i> Book FREE Consultation</a>
</div>
</section>
...
<div class="form-group"><label>Phone *</label><input type="tel" placeholder="+880 1XXX-XXXXXX" required></div>
</div>
<div class="form-group"><label>Email *</label><input type="email" placeholder="your@email.com" required></div>
<div style="display:grid;grid-template-columns:1fr 1fr;gap:16px">
<div class="form-group"><label>Preferred Country</label><select><option>Select Country</option><option>UK</option><option>USA</option><option>Canada</option><option>Australia</option><option>New Zealand</option><option>Malaysia</option><option>Europe</option></select></div>
<div class="form-group"><label>Study Level</label><select><option>Select Level</option><option>Bachelor's</option><option>Master's</option><option>PhD</option><option>Diploma</option></select></div>
</div>
<div class="form-group"><label>Message</label><textarea placeholder="Tell us about your study plans..."></textarea></div>
...
<div class="info-item"><div class="info-icon"><i class="fas fa-map-marker-alt"></i></div><div><h4>Dhanmondi Office</h4><p>Level 5, Road 27, Dhanmondi, Dhaka 1209</p></div></div>
<div class="info-item"><div class="info-icon"><i class="fas fa-map-marker-alt"></i></div><div><h4>Banani Office</h4><p>House 50, Block C, Road 11, Banani, Dhaka 1213</p></div></div>
<div class="info-item"><div class="info-icon"><i class="fas fa-phone"></i></div><div><h4>Phone</h4><p>+880 1XXX-XXXXXX</p></div></div>
<div class="info-item"><div class="info-icon"><i class="fas fa-envelope"></i></div><div><h4>Email</h4><p>info@eduglobal.com</p></div></div>
<div class="info-item"><div class="info-icon"><i class="fas fa-clock"></i></div><div><h4>Working Hours</h4><p>Saturday - Thursday: 10 AM - 6:30 PM</p></div></div>
</div>
</div></div>
</section>
...
<div class="logo" style="margin-bottom:16px"><div class="logo-icon">E</div><div class="logo-text">Edu<span>Global</span></div></div>
...
<a href="#"><i class="fab fa-linkedin-in"></i></a><a href="#"><i class="fab fa-youtube"></i></a><a href="#"><i class="fab fa-whatsapp"></i></a>
</div>
</div>
<div class="footer-links"><h4>Study Destinations</h4>
<a href="#">🇬🇧 United Kingdom</a><a href="#">🇺🇸 United States</a><a href="#">🇨🇦 Canada</a>
<a href="#">🇦🇺 Australia</a><a href="#">🇳🇿 New Zealand</a><a href="#">🇲🇾 Malaysia</a><a href="#">🇩🇪 Germany</a>
</div>
<div class="footer-links"><h4>Quick Links</h4>
<a href="#about">About Us</a><a href="#services">Our Services</a><a href="#scholarships">Scholarships</a>
<a href="#blog">Blog</a><a href="#events">Events</a><a href="#faq">FAQ</a><a href="#contact">Contact Us</a>
</div>
<div class="footer-contact"><h4>Head Office</h4>
...
<div class="footer-bottom"><p>&copy; 2026 EduGlobal Consultancy. All Rights Reserved.</p></div>
</div>
</footer>

<!-- WHATSAPP FLOAT -->
<a href="https://wa.me/8801XXXXXXXXX?text=Hi! I'd like to know about studying abroad." class="whatsapp-float" target="_blank"><i class="fab fa-whatsapp"></i></a>
